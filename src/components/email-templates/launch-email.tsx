...
export const LaunchEmail: React.FC<Readonly<LaunchEmailProps>> = ({
  email,
}) => (
    <div style={{
    ...
    <div style={{
      ...
      <div style={{ flex: '1', marginLeft: '12px' }}>
        ...
        <p style={{
          ...
          Ask questions, research, or generate ideas—switch between AI models as you work, with context automatically pulled from your open pages.
        </p>
        <p style={{
          fontSize: '12px',
          lineHeight: '1.4',
    ...
    <div style={{ marginBottom: '32px' }}>
      <p style={{
        ...
        Check out the more from me on <a href="https://stratumlabs.substack.com" style={{ color: '#ffffff' }} target="_blank">Substack</a> if you want more info on the roadmap ahead.
      </p>
